  ...
  List<Map<String, Object>> get groupedTransactionValues {
    return List.generate(7, (index) {
      ...
      return {
        'day': DateFormat.E()
        .format(weekDay)
        .substring(0,1), // formating the date
        'amount': totalSum
      }; // constructor E provide build method to define weekday (Mon, Tue, Wed, etc)..
    }).reversed.toList();
  }

  //Create method/function for totalSpending
...
// why not use the ListView.builder? 
// - ListView.builder direct fetch data only , we use mapping because there is logic and calculations included.
